function genElectromagneticPlants(inputs)
    ...
    item.icon = "__space-age__/graphics/icons/electromagnetic-plant.png"
    ...
    if inputs.tech then
        ...
        tech.icon = "__space-age__/graphics/technology/electromagnetic-plant.png"
        tech.icon_size = 256
